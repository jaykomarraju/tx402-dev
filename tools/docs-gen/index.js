...
Both SDKs are \`0.0.0\` on the registries today — an inert name placeholder that contains no working
code; the first functional release is \`0.1.0\`. Until then, \`npm install tx402\` and
\`pip install tx402\` fetch the placeholder. Do not depend on \`0.0.0\`.
`;
}

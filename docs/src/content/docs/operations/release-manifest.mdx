...
Authority for the format is
[ADR-012](https://github.com/neogeeks/tx402/blob/main/adr/012-manifest-signing-envelope.md)
and
[`core-spec/schemas/release-manifest.schema.json`](https://github.com/neogeeks/tx402/blob/main/core-spec/schemas/release-manifest.schema.json).
...
The current key, `tx402-release-1`, was generated locally for development.
...
**Before `0.1.0`**, the release key must be regenerated inside a secure

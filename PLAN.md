...
| O43 | **`normalizePolicyHost("https://./x")` returns the empty string, in both languages.** `new URL` gives hostname `"."`, and the trailing-dot strip that turns `a.test.` into `a.test` reduces it to `""`. Found by the S14 fuzz harness. **Not a bypass:** an empty host matches only the `"*"` pattern, which already allows everything, and it fails every specific allowlist entry. It is also _stable_ — the same URL normalizes identically on the initial request and on the paid retry, which is the property SPEC §6.3 actually depends on. Recorded rather than fixed: a fix changes frozen behaviour in two languages for no security gain, and the audit should decide whether an empty host ought to be refused outright rather than admitted by `"*"`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Agent            | ⬜ Recorded, for §11.2 to judge                 |
